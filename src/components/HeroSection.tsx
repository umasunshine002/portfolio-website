      ...
      <div className="container mx-auto px-4 z-10 mt-16">
        <div className="max-w-3xl mx-auto text-center md:text-left">
          ...
          <p
            ...
            className="text-lg mb-6 max-w-2xl mx-auto md:mx-0 opacity-0 -translate-y-10 transition-all duration-700"
          >
          ...
          <p
            ...
            className="text-lg mb-10 max-w-2xl mx-auto md:mx-0 opacity-0 -translate-y-10 transition-all duration-700"
          >
